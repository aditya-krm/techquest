...
export default function EnhancedPortfolio() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-800 text-white p-8 overflow-hidden">
      <motion.div
      ...
      >
        ...
        >
          ...
          <motion.div className="flex" variants={fadeInUp}>
            <Card className="bg-gray-800/50 border-gray-700 backdrop-blur-sm flex flex-col w-full">
              <CardHeader>
              ...
              <CardContent className="flex flex-col justify-between flex-grow">
                <div>
                  <div className="space-y-2 mb-4 cursor-pointer">
                    ...
                    >
                      <MailIcon className="mr-2" /> adkarmakar521@gmail.com
                    </motion.p>
                    <motion.p
                      whileHover={{ scale: 1.05 }}
                      className="flex items-center"
                    >
                      <PhoneIcon className="mr-2" /> 6296306334
                    </motion.p>
                  </div>
          ...
          <Card className="bg-gray-800/50 border-gray-700 backdrop-blur-sm">
            ...
            <CardContent>
              <p className="mb-4 leading-relaxed">
                I'm currently pursuing my B.Tech in Computer Science with
                hands-on experience in building full-stack applications using
                the MERN stack. Some of my notable projects include a real-time
                chat system, a social media platform, and a role-based
                dashboard.
              </p>
            ...
            <CardContent className="space-y-6">
              {[
                ...
                <motion.div
                  ...
                  className="bg-gray-700/30 p-6 rounded-lg shadow-lg transition-all duration-300 hover:shadow-xl"
                >
